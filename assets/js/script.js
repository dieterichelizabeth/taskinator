...
var taskFormHandler = function (event) {
  ...
  // If there is a data-task-id, get the id move to the completeEditTask function... else, package up data as an object and pass to createTaskEl function as an argument
  if (isEdit) {
